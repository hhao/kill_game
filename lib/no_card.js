...
$(function(){
	...
	$("#card").click(function(){						//产生角色分配界面
		...
		if($("input[name='police']").prop("checked")==true){
			var police_num = num.pop();
			$(".person_head_img").eq(police_num).attr('src','image/police.png');
			$(".person_page").eq(police_num).find('.back').attr('src','image/police.png');
		}
